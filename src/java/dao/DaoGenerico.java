...
public class DaoGenerico<T> implements Serializable
{
    ...
    private Class classePersistence;
    private String mensagem= " ";
    private EntityManager em;
    private String ordem= "id";
    private String filtro= " ";
    private Integer maximoObjetos= 8;
    ...
    public List<T> getListaObjetos() 
    {
        ...
        jpql += where;
        jpql += " order by " + ordem;
        totalObjetos= em.createQuery("select id from " + classePersistence.getSimpleName() + where + " order by " +
                ordem).getResultList().size();
